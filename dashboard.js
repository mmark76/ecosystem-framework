...
const TRANSLATIONS = Object.freeze({
  en: Object.freeze({
    ...
    assistantPlaceholder: 'Reference assistant control. Connect it to the approved project assistant when adopting this template.',
    settings: 'Settings',
    info: 'Info',
    ...
    close: 'Close',
    closeAssistant: 'Close Template Assistant',
    ...
    analyticsDescription: 'No analytics service is configured in this template.',
  ...
  el: Object.freeze({
    ...
    assistantPlaceholder: 'Πρότυπο στοιχείο βοηθού. Συνδέστε το με τον εγκεκριμένο βοηθό του έργου κατά την υιοθέτηση.',
    settings: 'Ρυθμίσεις',
    info: 'Πληροφορίες',
    navigation: 'Πλοήγηση',
    home: 'Αρχική',
    ...
    close: 'Κλείσιμο',
    closeAssistant: 'Κλείσιμο Βοηθού Προτύπου',
    ...
    analyticsDescription: 'Δεν έχει ρυθμιστεί υπηρεσία αναλυτικών σε αυτό το πρότυπο.',
