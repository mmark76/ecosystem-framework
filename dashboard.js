...
const TRANSLATIONS = Object.freeze({
  en: Object.freeze({
    ...
    assistantPlaceholder: 'Framework reference assistant. No external Assistant backend is connected.',
    settings: 'Settings',
    info: 'Info',
    ...
    importantDescription: 'This site is the public reference point for the Markellos Ecosystem framework, standards and operating model.',
    feedbackDescription: 'No public feedback channel is configured for this site.',
    licenseDescription: 'Refer to the approved project licensing documentation.',
    privacyDescription: 'Appearance preferences are stored locally on this device; no analytics service is configured.',
    analyticsDescription: 'No analytics service is configured for this Framework site.',
    copyrightDescription: 'Copyright applies to the Framework site and related project materials.',
    languageStatus: 'Shell controls support English and Greek. Framework reference content remains English.',
  ...
  el: Object.freeze({
    ...
    assistantName: 'Βοηθός Framework',
    assistantStatus: 'Έτοιμος',
    assistantLabel: 'ΒΟΗΘΟΣ ΕΡΓΟΥ',
    assistantPlaceholder: 'Βοηθός αναφοράς του Framework. Δεν είναι συνδεδεμένο εξωτερικό backend Assistant.',
    settings: 'Ρυθμίσεις',
    info: 'Πληροφορίες',
    navigation: 'Πλοήγηση',
    home: 'Αρχική',
    ...
    close: 'Κλείσιμο',
    closeAssistant: 'Κλείσιμο Βοηθού Framework',
    ...
    importantDescription: 'Αυτός ο ιστότοπος είναι το δημόσιο σημείο αναφοράς για το Framework, τα πρότυπα και το λειτουργικό μοντέλο του Markellos Ecosystem.',
    feedbackDescription: 'Δεν έχει ρυθμιστεί δημόσιο κανάλι σχολίων για αυτόν τον ιστότοπο.',
    licenseDescription: 'Ανατρέξτε στην εγκεκριμένη τεκμηρίωση αδειοδότησης του έργου.',
    privacyDescription: 'Οι προτιμήσεις εμφάνισης αποθηκεύονται τοπικά σε αυτή τη συσκευή· δεν έχει ρυθμιστεί υπηρεσία αναλυτικών.',
    analyticsDescription: 'Δεν έχει ρυθμιστεί υπηρεσία αναλυτικών για τον ιστότοπο Framework.',
    copyrightDescription: 'Η προστασία πνευματικών δικαιωμάτων ισχύει για τον ιστότοπο Framework και το σχετικό υλικό έργων.',
    languageStatus: 'Τα στοιχεία του κελύφους υποστηρίζουν Ελληνικά και Αγγλικά. Το περιεχόμενο αναφοράς του Framework παραμένει στα Αγγλικά.',
